...
@section('title', 'Upload Massal Pengadaan')

@section('breadcrumb')
    <a href="{{ route('admin.pengadaan.index') }}" class="hover:text-primary">Pengadaan</a>
...
@section('content')
<div class="max-w-4xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Upload Massal Pengadaan Barang & Jasa</h1>

    <form action="{{ route('admin.pengadaan.bulk-store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf

        <div class="card bg-white rounded-lg shadow p-6 space-y-4">
            <h2 class="text-lg font-semibold text-gray-900 border-b pb-2">Pengaturan</h2>
            <p class="text-sm text-gray-500">Judul dan deskripsi otomatis dari nama file.</p>
        ...
        <div class="card bg-white rounded-lg shadow p-6 space-y-4">
            ...
            >
                ...
                <p class="text-xs text-gray-500 mt-2">Format: PDF, DOC, DOCX, XLS, XLSX. Maks: 10MB per file</p>
