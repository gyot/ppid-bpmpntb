        ...
        <div class="card bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nomor" value="{{ old('nomor') }}" placeholder="No. 14 Tahun 2008" class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary">
                </div>
                <div>
                    <label class="input-label block text-sm font-medium text-gray-700 mb-1">Pembuat</label>
                    <input type="text" name="pembuat" value="{{ old('pembuat') }}" placeholder="DPR RI / Pemerintah / dll" class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="kategori" required class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary">
                        <option value="uu" {{ old('kategori') == 'uu' ? 'selected' : '' }}>Undang-Undang</option>
                        <option value="pp" {{ old('kategori') == 'pp' ? 'selected' : '' }}>Peraturan Pemerintah</option>
                        <option value="perma" {{ old('kategori') == 'perma' ? 'selected' : '' }}>Peraturan MA</option>
                        <option value="perki" {{ old('kategori') == 'perki' ? 'selected' : '' }}>Peraturan KI</option>
                        <option value="permendikbud" {{ old('kategori') == 'permendikbud' ? 'selected' : '' }}>Permendikbud</option>
                        <option value="lainnya" {{ old('kategori') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                </div>
                <div>
                    <label class="input-label block text-sm font-medium text-gray-700 mb-1">Tanggal</label>
                    <input type="date" name="tanggal" value="{{ old('tanggal') }}" class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="url" name="link_eksternal" value="{{ old('link_eksternal') }}" placeholder="https://..." class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary">
                </div>
            </div>
