...
@section('title', 'Upload Massal Dokumen')
...
@section('content')
<div class="max-w-4xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Upload Massal Dokumen</h1>

    <form action="{{ route('admin.dokumen.bulk-store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="card bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <p class="text-sm text-gray-500">Pengaturan ini akan diterapkan ke semua file. Judul dan deskripsi otomatis dari nama file.</p>
