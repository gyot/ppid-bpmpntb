...
@section('breadcrumb')
    <a href="{{ route('admin.dokumen.index') }}" class="hover:text-primary">Dokumen</a>
...
@section('content')
<div class="max-w-4xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Tambah Dokumen</h1>
    ...
    <form action="{{ route('admin.dokumen.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="card bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
            ...
            <div>
                <label class="input-label block text-sm font-medium text-gray-700 mb-1">File Dokumen <span class="text-red-500">*</span></label>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.dokumen.index') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm">Batal</a>
        </div>
    </form>
</div>
@endsection
