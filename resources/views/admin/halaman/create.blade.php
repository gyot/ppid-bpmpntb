...
@section('content')
<div class="max-w-4xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Tambah Halaman</h1>

    <form action="{{ route('admin.halaman.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="card bg-white rounded-lg shadow p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="slug" value="{{ old('slug') }}" class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary @error('slug') border-red-500 @enderror" placeholder="otomatis dari judul jika kosong">
            ...
            <div>
                ...
                <textarea name="content" rows="15" required class="input-field w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary focus:border-primary @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
